	...
	static function friendlyError($statusCode = 500, $friendlyErrorMessage = null, $friendlyErrorDetail = null) {
		...
		if(Director::is_ajax()) {
			...
			if(file_exists($errorFilePath)) {
				...
				$message = sprintf('<h5 style="margin:0;">%s</h5><small>%s</small>', $friendlyErrorMessage, $friendlyErrorDetail);
 
				echo str_replace('%ERROR_MESSAGE%',$message, str_replace('$BaseURL', Director::absoluteBaseURL(), $content));
