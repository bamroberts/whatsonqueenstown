...
class DataObject extends ViewableData implements DataObjectInterface, i18nEntityProvider {
	...
	/**
	 * Does the same as DataObject::get, except it returns the query object for inspection instead
	 * 
	 ...
	 * @return SQLQuery
	 */
	public static function get_query($callerClass, $filter = "", $sort = "", $join = "", $limit = "", $containerClass = "DataObjectSet") {
		return singleton($callerClass)->instance_get_query($filter, $sort, $join, $limit, $containerClass);
	}
	 ...
	 * @return SQLQuery
	 */
	public function instance_get_query($filter = "", $sort = "", $join = "", $limit="", $containerClass = "DataObjectSet") {
		if(!DB::isActive()) {
			user_error("DataObjects have been requested before the database is ready. Please ensure your database connection details are correct, your database has been built, and that you are not trying to query the database in _config.php.", E_USER_ERROR);
		}
	...
	public function flushComponents($component = null) {
		if($component) {
