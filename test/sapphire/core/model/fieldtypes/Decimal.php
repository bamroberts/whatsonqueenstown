...
class Decimal extends DBField {
	...
	function requireField() {
		$parts = Array('datatype' => 'decimal', 'precision' => "$this->wholeSize,$this->decimalSize", 'default' => number_format($this->defaultValue, $this->decimalSize), 'arrayValue' => $this->arrayValue);
