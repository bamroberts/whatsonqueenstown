...
class ComponentSet extends DataObjectSet {
	...
	/**
	 * Debug information about children of the current component set.
	 */
...
<ul>
	<li>ownerObj: {$this->ownerObj}</li>
	<li>ownerClass: {$this->ownerClass}</li>
	<li>tableName: {$this->tableName}</li>
	<li>childClass: {$this->childClass}</li>
	<li>joinField: {$this->joinField}</li>
