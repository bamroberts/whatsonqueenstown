<div id="$id" class="$CSSClasses field">
	...
	<% end_if %>
	<table class="data table table-striped table-condensed table-bordered">
		<thead>
			<tr>
	...
	<% if Print %><% else %><div class="utility">
		<% control Utility %>
			<span class="item"><a href="$Link" class="btn btn-default"><i class="icon-download"></i> $Title</a></span>
		<% end_control %>
	</div><% end_if %>
</div>
